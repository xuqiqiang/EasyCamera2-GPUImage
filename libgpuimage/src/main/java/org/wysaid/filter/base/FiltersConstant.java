 ...
 */
@Deprecated
public class FiltersConstant {

    public static final String NAME_FILTERS[] = {
            "1977",
            "1977_mix",
            "Brooklyn",
            "Moon",
    };
    private static final String mPath = "filter";
    @SuppressLint("SdCardPath")
    private static final String mFilterBrooklyn = "/sdcard/" + mPath + "/brooklyn.png";
    public static final FiltersLoader mFiltersLoader = new FiltersLoader() {
        @Override
        public void onFilterLoad(int id, int width, int height) {
            if (id == 3) { // Brooklyn
                saveBitmap(filterBrooklyn(width, height), mFilterBrooklyn);
            }
        }
    };
    public static final String FILTERS[] = {
            ...
            "@colormul mat 0.6965 0.3845 0.099 0.1745 0.843 0.084 0.136 0.267 0.5655 @adjust saturation 1.4 @adjust hue 5.75959", // 1977
            "@pixblend screen 243 106 188 76 100 @adjust contrast 1.1 @adjust brightness 0.1 @adjust saturation 1.3", // 1977_mix
            "@blend overlay file://" + mFilterBrooklyn + " 100 @adjust contrast 0.9 @adjust brightness 0.1 ", // Brooklyn
            "@pixblend softlight 160 160 160 255 100 @pixblend lighten 56 56 56 255 100 @colormul mat 0.3086 0.6094 0.082 0.3086 0.6094 0.082 0.3086 0.6094 0.082 @adjust contrast 1.1 @adjust brightness 0.1 ", // Moon
    ...
    public static Bitmap filterBrooklyn(int width, int height) {
...
//        String filePath = mFilterBrooklyn;
    ...
    public interface FiltersLoader {
        void onFilterLoad(int id, int width, int height);
    }
}
