...
namespace CGE
{
    ...
    CGEMutipleEffectFilter::CGEMutipleEffectFilter() : m_loadFunc(nullptr), m_unloadFunc(nullptr), m_loadParam(nullptr), m_unloadParam(nullptr), m_texCache(0), m_isWrapper(false), m_texLoadFunc(nullptr), m_texLoadParam(nullptr)
	{
